...
export function AuthWindow({
  ...
  return (
    <div className="max-w-md mx-auto mt-12 md:mt-24 px-4">
      <div className="bg-card p-10 md:p-14 rounded-[2.5rem] shadow-terra-soft relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {error && (
            <div className="mb-8 p-4 bg-destructive/10 text-destructive text-sm rounded-2xl text-center">
              {error}
            </div>
          )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-muted/30 rounded-2xl py-4 pl-12 pr-4 text-sm focus:ring-4 focus:ring-primary/5 transition-all outline-none"
                  required
                />
              </div>
            </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-card py-4 rounded-2xl hover:bg-muted transition-all group shadow-sm"
          >
